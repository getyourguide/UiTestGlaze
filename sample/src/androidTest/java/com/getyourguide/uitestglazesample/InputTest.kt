...
class InputTest {
    ...
    fun testInputText() {
        ...
        with(UiTestGlaze()) {
            ...
            assert(Assertion.NotVisible(UiElementIdentifier.Text("UiTestGlaze rocks!")), false)
    ...
    fun testSwitchIsChecked() {
        ...
        with(UiTestGlaze()) {
            tap(UiElementIdentifier.Text("Input", true))
            assert(Assertion.NotChecked(UiElementIdentifier.Text("Really nice switch")), false)

            tap(UiElementIdentifier.Text("Really nice switch"))
            assert(Assertion.Checked(UiElementIdentifier.Text("Really nice switch")), false)
        }
    }
    ...
    fun testCheckboxIsChecked() {
        ...
        with(UiTestGlaze()) {
            tap(UiElementIdentifier.Text("Input", true))
            assert(Assertion.NotChecked(UiElementIdentifier.Id(R.id.checkbox)), false)

            tap(UiElementIdentifier.Id(R.id.checkbox))
            assert(Assertion.Checked(UiElementIdentifier.Id(R.id.checkbox)), false)
        }
    }
}
